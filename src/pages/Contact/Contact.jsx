...
import { Send, Phone, MapPin, Mail, PhoneCallIcon } from "lucide-react";
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "90f4b8af-e590-42b0-beaf-10b18f6sds6a703"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">dibbameghana27@gmail.com</p>
                  </div>
                </div>

                  <div className="flex items-center space-x-4">
                  <div className="bg-purple-500/10 p-3 rounded-lg">
                    <PhoneCallIcon className="w-6 h-6 text-purple-400" />
                  </div>
                  <div>
                    <h3 className="font-semibold">Phone</h3>
                    <p className="text-gray-400">8247347013</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Sri ram nagar2 ,Narasannapeta srikakulam-532421</p>
                  </div>
                </div>
              </div>
            </div>
